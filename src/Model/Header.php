...
class Header implements \JsonSerializable
{
     ...
     */
    public function setAppRegion($app_region)
    {
     ...
     */
    public function setAppVersionMinor($app_version_minor)
    {
     ...
     */
    public function setBuildSerial($build_serial)
    {
     ...
     * @param mixed $cpu_abi
     */
    public function setCpuAbi($cpu_abi)
    {
     ...
     * @param int $device_id
     */
    public function setDeviceId(int $device_id)
    {
     ...
     */
    public function setDisplayDensity($display_density)
    {
     ...
     */
    public function setDensityDpi($density_dpi)
    {
     ...
     * @param mixed $os_api
     */
    public function setOsApi($os_api)
    {
        $this->os_api = $os_api;
    }
     ...
     * @param int $tz_offset
     */
    public function setTzOffset(int $tz_offset)
    {
     ...
     */
    public function setTzName(string $tz_name)
    {
