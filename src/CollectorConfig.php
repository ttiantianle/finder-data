...
class CollectorConfig
{
     ...
     */
    public static function initOpenapi(array $openapi)
    {
        if (!$openapi) {
            return;
        }
     ...
     * @param OpenapiConfig $openapi
     */
    public static function setOpenapi(OpenapiConfig $openapi)
    {
     ...
     * @param array $appKeys
     */
    public static function setAppKeys(array $appKeys)
    {
